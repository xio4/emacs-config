...
;;;; ecb
       (ecb-bucket-token-face (:bold t :size "10pt"))
       (ecb-default-general-face (nil))
       (ecb-default-highlight-face (:background ,bg-hc :foreground ,yellow))
       (ecb-directories-general-face (nil))
       (ecb-directory-face (:background ,bg-hc :foreground ,yellow))
       (ecb-history-face (:background ,bg-hc :foreground ,yellow))
       (ecb-history-general-face (nil))
       (ecb-method-face (:background ,bg-hc :foreground ,yellow))
       (ecb-methods-general-face (nil))
       (ecb-source-face (:background ,bg-hc :foreground ,yellow))
       (ecb-source-in-directories-buffer-face (:foreground ,blue))
       (ecb-sources-general-face (nil))
       (ecb-token-header-face (:background bg-base))
       (ecb-type-token-class-face (:bold t :size "10pt"))
       (ecb-type-token-enum-face (:bold t :size "10pt"))
       (ecb-type-token-group-face (:bold t :size "10pt" :foreground "dimgray"))
       (ecb-type-token-interface-face (:bold t :size "10pt"))
       (ecb-type-token-struct-face (:bold t :size "10pt"))
       (ecb-type-token-typedef-face (:bold t :size "10pt"))
...
(deftheme ecfg-dark "The dark variant of the Solarized colour theme")
(ecfg-create-theme
 'ecfg-dark
;; Solarized theme
 '(;; emphasized content
...
(provide-theme 'ecfg-dark)
(enable-theme 'ecfg-dark)
